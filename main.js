        ...
        for(const item of Items) {
            ...
            html += `
                    <tr>
                        ...
                        <td><input type="text" name="${item.type}" value="${item.type}"></td>
                        <td name="description"><input type="text" name="${item.description}" value="${item.description}"></td>
                        <td name="um"><input type="text" name="${item.um}" value="${item.um}"></td>
                        <td name="cantidad"><input type="text" name="${item.quantity}" value="${item.quantity}"></td>
                        <td id="${item.id}">
